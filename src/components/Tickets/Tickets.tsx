  ...
  const handleAdd = () => {
    ...
    let data = {
      ...
      data: {
        ...
        workspace: import.meta.env.REACT_APP_ASANA_WORKSPACE, //Replace this with your Asana workspace ID
      },
    };
    if (!addedTicketStatus)
      fetch("https://app.asana.com/api/1.0/tasks", {
        ...
        headers: {
          ...
          Authorization: import.meta.env.REACT_APP_ASANA_KEY, //Replace this with your API key
        },
